...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FacePostApp.EventListeners.TaskCompletionListeners, FacePostApp", TaskCompletionListeners.class, __md_methods);
	}
	...
	public TaskCompletionListeners ()
	{
		...
		if (getClass () == TaskCompletionListeners.class)
			mono.android.TypeManager.Activate ("FacePostApp.EventListeners.TaskCompletionListeners, FacePostApp", "", this, new java.lang.Object[] {  });
	}
